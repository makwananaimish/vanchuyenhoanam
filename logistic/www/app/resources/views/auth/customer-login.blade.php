        ...
        <div class="col-12 py-sm-64 py-lg-0">
            <div class="row align-items-center justify-content-center h-100 mx-4 mx-sm-n32">
                <div class="col-12 col-md-4 col-xl-4 col-xxxl-4 px-8 px-sm-0 pt-24 pb-48">
                    ...
                    <form method="POST" class="mt-16 mt-sm-32 mb-8" action="{{ route('customer.login') }}">
                        @csrf

                        <div class="mb-16">
                            <label for="loginPhone" class="form-label">SĐT :</label>
                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                name="phone" id="loginPhone" value="{{ old('phone') }}" required
