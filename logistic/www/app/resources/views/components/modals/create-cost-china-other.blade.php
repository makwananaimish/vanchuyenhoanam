<div class="modal fade" id="create-cost-china-other" tabindex="-1" aria-labelledby="create-cost-china-other" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="varyingModalLabel">Thêm các khoản chi khác</h5>
            ...
            <form method="POST" action="{{ route('cost_china.create') }}" enctype="multipart/form-data">
                ...
                <input type="hidden" name="type" value="{{ \App\CostChina::TYPE_OTHER }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="col-form-label">Nội dung khoản chi:</label>
