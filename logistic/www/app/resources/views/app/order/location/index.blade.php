...
@section('content')
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('order.location', ['location' => $location]) }}">Vận Đơn</a>
                </li>
    ...
    <div class="col-12 col-md-6">
        <div class="hp-page-title">
            <h1 class="mb-8 text-uppercase">DANH SÁCH VẬN ĐƠN {{ $location->name }}</h1>
        </div>
    </div>
    ...
    <div class="col-12">
                ...
                <div class="row justify-content-between">
                    <div class="col-12 mt-16">
                        <form class="customer-filter-form"
                            action="{{ route('order.location', ['location' => $location]) }}">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><b>Vị trí khởi tạo</b></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @if ($order->is_express)
                                                    <button class="btn btn-primary text-nowrap mr-2"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#merge-order-{{ $order->id }}">
                                                        Ghép đơn
                                                    </button>
                                                @endif
        ...
        @include('components.modals.create-order', [
            'redirect' => route('order.location', ['location' => $location]),
            'truck' => null,
            'customers' => $customers,
